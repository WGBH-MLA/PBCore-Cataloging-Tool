...
public class CSVMapperHelper {
    ...
    public static final Logger LOGGER = Logger.getLogger(CSVMapperHelper.class.getName());
    ...
    public static void generateElementMappers() {
        ...
        CSVElementMapper assetTypeElementMapper = new CSVElementMapper(ASSET_TYPE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_TYPE,
                Arrays
                        .asList(new CSVAttributeMapper(ASSET_TYPE_SOURCE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_TYPE_SOURCE),
                                new CSVAttributeMapper(ASSET_TYPE_REF_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_TYPE_REF),
                                new CSVAttributeMapper(ASSET_TYPE_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_TYPE_VERSION),
                                new CSVAttributeMapper(ASSET_TYPE_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_TYPE_ANNOTATION)));

        CSVElementMapper assetDateElementMapper = new CSVElementMapper(ASSET_DATE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_DATE,
                Arrays
                        .asList(new CSVAttributeMapper(ASSET_DATE_DATE_TYPE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_DATE_DATE_TYPE),
                                new CSVAttributeMapper(ASSET_DATE_SOURCE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_DATE_SOURCE),
                                new CSVAttributeMapper(ASSET_DATE_REF_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_DATE_REF),
                                new CSVAttributeMapper(ASSET_DATE_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_DATE_VERSION),
                                new CSVAttributeMapper(ASSET_DATE_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ASSET_DATE_ANNOTATION)));

        CSVElementMapper identifierElementMapper = new CSVElementMapper(IDENTIFIER,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_IDENTIFIER,
                Arrays
                        .asList(new CSVAttributeMapper(IDENTIFIER_SOURCE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_IDENTIFIER_SOURCE),
                                new CSVAttributeMapper(IDENTIFIER_REF_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_IDENTIFIER_REF),
                                new CSVAttributeMapper(IDENTIFIER_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_IDENTIFIER_VERSION),
                                new CSVAttributeMapper(IDENTIFIER_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_IDENTIFIER_ANNOTATION)));

        CSVElementMapper titleElementMapper = new CSVElementMapper(TITLE, PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE,
                Arrays
                        .asList(new CSVAttributeMapper(TITLE_TYPE_TITLE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_TITLE_TYPE),
                                new CSVAttributeMapper(TITLE_TYPE_SOURCE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_TITLE_TYPE_SOURCE),
                                new CSVAttributeMapper(TITLE_TYPE_REF_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_TITLE_TYPE_REF),
                                new CSVAttributeMapper(TITLE_TYPE_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_TITLE_TYPE_VERSION),
                                new CSVAttributeMapper(TITLE_TYPE_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_TITLE_TYPE_ANNOTATION),
                                new CSVAttributeMapper(TITLE_SOURCE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_SOURCE),
                                new CSVAttributeMapper(TITLE_REF_ATTR, PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_REF),
                                new CSVAttributeMapper(TITLE_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_VERSION),
                                new CSVAttributeMapper(TITLE_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_ANNOTATION),
                                new CSVAttributeMapper(TITLE_START_TIME_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_START_TIME),
                                new CSVAttributeMapper(TITLE_END_TIME_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_END_TIME),
                                new CSVAttributeMapper(TITLE_TIME_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_TITLE_TIME_ANNOTATION)));

        CSVElementMapper subjectElementMapper = new CSVElementMapper(SUBJECT,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT,
                Arrays
                        .asList(new CSVAttributeMapper(SUBJECT_TYPE_SUBJECT_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_SUBJECT_TYPE),
                                new CSVAttributeMapper(SUBJECT_TYPE_SOURCE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_SUBJECT_TYPE_SOURCE),
                                new CSVAttributeMapper(SUBJECT_TYPE_REF_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_SUBJECT_TYPE_REF),
                                new CSVAttributeMapper(SUBJECT_TYPE_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_SUBJECT_TYPE_VERSION),
                                new CSVAttributeMapper(SUBJECT_TYPE_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_SUBJECT_TYPE_ANNOTATION),
                                new CSVAttributeMapper(SUBJECT_SOURCE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_SOURCE),
                                new CSVAttributeMapper(SUBJECT_REF_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_REF),
                                new CSVAttributeMapper(SUBJECT_VERSION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_VERSION),
                                new CSVAttributeMapper(SUBJECT_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_ANNOTATION),
                                new CSVAttributeMapper(SUBJECT_START_TIME_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_START_TIME),
                                new CSVAttributeMapper(SUBJECT_END_TIME_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_END_TIME),
                                new CSVAttributeMapper(SUBJECT_TIME_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SUBJECT_TIME_ANNOTATION)));

        CSVElementMapper descriptionElementMapper = new CSVElementMapper(DESCRIPTION,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION,
                Arrays
                        .asList(new CSVAttributeMapper(DESCRIPTION_TYPE_DESCRIPTION_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_DESCRIPTION_TYPE),
                                new CSVAttributeMapper(DESCRIPTION_TYPE_SOURCE_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_DESCRIPTION_TYPE_SOURCE),
                                new CSVAttributeMapper(DESCRIPTION_TYPE_REF_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_DESCRIPTION_TYPE_REF),
                                new CSVAttributeMapper(DESCRIPTION_TYPE_VERSION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_DESCRIPTION_TYPE_VERSION),
                                new CSVAttributeMapper(DESCRIPTION_TYPE_ANNOTATION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_DESCRIPTION_TYPE_ANNOTATION),
                                new CSVAttributeMapper(SEGMENT_TYPE_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_SEGMENT_TYPE),
                                new CSVAttributeMapper(SEGMENT_TYPE_SOURCE_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_SEGMENT_TYPE_SOURCE),
                                new CSVAttributeMapper(SEGMENT_TYPE_REF_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_SEGMENT_TYPE_REF),
                                new CSVAttributeMapper(SEGMENT_TYPE_VERSION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_SEGMENT_TYPE_VERSION),
                                new CSVAttributeMapper(SEGMENT_TYPE_ANNOTATION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_SEGMENT_TYPE_ANNOTATION),
                                new CSVAttributeMapper(START_TIME_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_START_TIME),
                                new CSVAttributeMapper(END_TIME_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_END_TIME),
                                new CSVAttributeMapper(TIME_ANNOTATION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_TIME_ANNOTATION),
                                new CSVAttributeMapper(SOURCE_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_SOURCE),
                                new CSVAttributeMapper(REF_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_REF),
                                new CSVAttributeMapper(VERSION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_VERSION),
                                new CSVAttributeMapper(ANNOTATION_DESCRIPTION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_DESCRIPTION_ANNOTATION)));

        CSVElementMapper genreElementMapper = new CSVElementMapper(GENRE, PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_GENRE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_SOURCE),
                                new CSVAttributeMapper(REF_GENRE_ATTR, PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_REF),
                                new CSVAttributeMapper(VERSION_GENRE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_GENRE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_ANNOTATION),
                                new CSVAttributeMapper(START_TIME_GENRE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_START_TIME),
                                new CSVAttributeMapper(END_TIME_GENRE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_END_TIME),
                                new CSVAttributeMapper(TIME_ANNOTATION_GENRE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_GENRE_TIME_ANNOTATION)));

        CSVElementMapper relationTypeElementMapper = new CSVElementMapper(RELATION_TYPE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_TYPE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_RELATION_TYPE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_RELATION_TYPE),
                                new CSVAttributeMapper(REF_RELATION_TYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_TYPE_REF),
                                new CSVAttributeMapper(VERSION_RELATION_TYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_TYPE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_RELATION_TYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_TYPE_ANNOTATION)),
                true);

        CSVElementMapper relationIdentifierElementMapper = new CSVElementMapper(RELATION_IDENTIFIER,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_IDENTIFIER,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_RELATION_IDENTIFIER_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_RELATION_IDENTIFIER),
                                new CSVAttributeMapper(REF_RELATION_IDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_IDENTIFIER_REF),
                                new CSVAttributeMapper(VERSION_RELATION_IDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_IDENTIFIER_VERSION),
                                new CSVAttributeMapper(ANNOTATION_RELATION_IDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RELATION_IDENTIFIER_ANNOTATION)),
                true);

        CSVElementMapper coverageElementMapper = new CSVElementMapper(COVERAGE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_COVERAGE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_COVERAGE),
                                new CSVAttributeMapper(REF_COVERAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_REF),
                                new CSVAttributeMapper(VERSION_COVERAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_COVERAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_ANNOTATION),
                                new CSVAttributeMapper(START_TIME_COVERAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_START_TIME),
                                new CSVAttributeMapper(END_TIME_COVERAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_END_TIME),
                                new CSVAttributeMapper(TIME_ANNOTATION_COVERAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_TIME_ANNOTATION)),
                true);

        CSVElementMapper coverageTypeElementMapper = new CSVElementMapper(COVERAGE_TYPE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_COVERAGE_TYPE, Arrays.asList(), true);

        CSVElementMapper audienceLevelElementMapper = new CSVElementMapper(AUDIENCE_LEVEL,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_LEVEL,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_AUDIENCE_LEVEL_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_AUDIENCE_LEVEL),
                                new CSVAttributeMapper(REF_AUDIENCE_LEVEL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_LEVEL_REF),
                                new CSVAttributeMapper(VERSION_AUDIENCE_LEVEL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_LEVEL_VERSION),
                                new CSVAttributeMapper(ANNOTATION_AUDIENCE_LEVEL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_LEVEL_ANNOTATION)));

        CSVElementMapper audienceRatingElementMapper = new CSVElementMapper(AUDIENCE_RATING,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_RATING,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_AUDIENCE_RATING_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_AUDIENCE_RATING),
                                new CSVAttributeMapper(REF_AUDIENCE_RATING_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_RATING_REF),
                                new CSVAttributeMapper(VERSION_AUDIENCE_RATING_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_RATING_VERSION),
                                new CSVAttributeMapper(ANNOTATION_AUDIENCE_RATING_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_AUDIENCE_RATING_ANNOTATION)));

        CSVElementMapper creatorElementMapper = new CSVElementMapper(CREATOR,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR,
                Arrays
                        .asList(new CSVAttributeMapper(AFFILIATION_CREATOR_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_AFFFILIATION),
                                new CSVAttributeMapper(AFFILIATION_SOURCE_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_AFFFILIATION_SOURCE),
                                new CSVAttributeMapper(AFFILIATION_REF_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_AFFFILIATION_REF),
                                new CSVAttributeMapper(AFFILIATION_VERSION_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_AFFFILIATION_VERSION),
                                new CSVAttributeMapper(AFFILIATION_ANNOTATION_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_AFFFILIATION_ANNOTATION),
                                new CSVAttributeMapper(SOURCE_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_CREATOR),
                                new CSVAttributeMapper(REF_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_REF),
                                new CSVAttributeMapper(VERSION_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_VERSION),
                                new CSVAttributeMapper(ANNOTATION_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_ANNOTATION),
                                new CSVAttributeMapper(START_TIME_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_START_TIME),
                                new CSVAttributeMapper(END_TIME_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_END_TIME),
                                new CSVAttributeMapper(TIME_ANNOTATION_CREATOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_TIME_ANNOTATION)),
                true);

        CSVElementMapper creatorRoleElementMapper = new CSVElementMapper(CREATOR_ROLE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_ROLE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_CREATOR_ROLE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_CREATOR_ROLE),
                                new CSVAttributeMapper(REF_CREATOR_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_ROLE_REF),
                                new CSVAttributeMapper(VERSION_CREATOR_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_ROLE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_CREATOR_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CREATOR_ROLE_ANNOTATION)),
                true);

        CSVElementMapper contributorElementMapper = new CSVElementMapper(CONTRIBUTOR,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR,
                Arrays
                        .asList(new CSVAttributeMapper(AFFILIATION_CONTRIBUTOR_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_AFFFILIATION),
                                new CSVAttributeMapper(AFFILIATION_SOURCE_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_AFFFILIATION_SOURCE),
                                new CSVAttributeMapper(AFFILIATION_REF_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_AFFFILIATION_REF),
                                new CSVAttributeMapper(AFFILIATION_VERSION_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_AFFFILIATION_VERSION),
                                new CSVAttributeMapper(AFFILIATION_ANNOTATION_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_AFFFILIATION_ANNOTATION),
                                new CSVAttributeMapper(SOURCE_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_CONTRIBUTOR),
                                new CSVAttributeMapper(REF_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_REF),
                                new CSVAttributeMapper(VERSION_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_VERSION),
                                new CSVAttributeMapper(ANNOTATION_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_ANNOTATION),
                                new CSVAttributeMapper(START_TIME_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_START_TIME),
                                new CSVAttributeMapper(END_TIME_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_END_TIME),
                                new CSVAttributeMapper(TIME_ANNOTATION_CONTRIBUTOR_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_TIME_ANNOTATION)),
                true);

        CSVElementMapper contributorRoleElementMapper = new CSVElementMapper(CONTRIBUTOR_ROLE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_ROLE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_CONTRIBUTOR_ROLE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_CONTRIBUTOR_ROLE),
                                new CSVAttributeMapper(REF_CONTRIBUTOR_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_ROLE_REF),
                                new CSVAttributeMapper(VERSION_CONTRIBUTOR_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_ROLE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_CONTRIBUTOR_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_CONTRIBUTOR_ROLE_ANNOTATION)),
                true);

        CSVElementMapper publisherElementMapper = new CSVElementMapper(PUBLISHER,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER,
                Arrays
                        .asList(new CSVAttributeMapper(AFFILIATION_PUBLISHER_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_AFFFILIATION),
                                new CSVAttributeMapper(AFFILIATION_SOURCE_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_AFFFILIATION_SOURCE),
                                new CSVAttributeMapper(AFFILIATION_REF_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_AFFFILIATION_REF),
                                new CSVAttributeMapper(AFFILIATION_VERSION_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_AFFFILIATION_VERSION),
                                new CSVAttributeMapper(AFFILIATION_ANNOTATION_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_AFFFILIATION_ANNOTATION),
                                new CSVAttributeMapper(SOURCE_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_PUBLISHER),
                                new CSVAttributeMapper(REF_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_REF),
                                new CSVAttributeMapper(VERSION_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_VERSION),
                                new CSVAttributeMapper(ANNOTATION_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_ANNOTATION),
                                new CSVAttributeMapper(START_TIME_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_START_TIME),
                                new CSVAttributeMapper(END_TIME_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_END_TIME),
                                new CSVAttributeMapper(TIME_ANNOTATION_PUBLISHER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_TIME_ANNOTATION)),
                true);

        CSVElementMapper publisherRoleElementMapper = new CSVElementMapper(PUBLISHER_ROLE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_ROLE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_PUBLISHER_ROLE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_PUBLISHER_ROLE),
                                new CSVAttributeMapper(REF_PUBLISHER_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_ROLE_REF),
                                new CSVAttributeMapper(VERSION_PUBLISHER_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_ROLE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_PUBLISHER_ROLE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_PUBLISHER_ROLE_ANNOTATION)),
                true);

        CSVElementMapper rightsSummaryElementMapper = new CSVElementMapper(RIGHTS_SUMMARY,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_SUMMARY,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_RIGHTS_SUMMARY_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_RIGHTS_SUMMARY),
                                new CSVAttributeMapper(REF_RIGHTS_SUMMARY_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_SUMMARY_REF),
                                new CSVAttributeMapper(VERSION_RIGHTS_SUMMARY_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_SUMMARY_VERSION),
                                new CSVAttributeMapper(ANNOTATION_RIGHTS_SUMMARY_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_SUMMARY_ANNOTATION)),
                true);

        CSVElementMapper rightsLinkElementMapper = new CSVElementMapper(RIGHTS_LINK,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_LINK,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_RIGHTS_LINK_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_SOURCE_RIGHTS_LINK),
                                new CSVAttributeMapper(REF_RIGHTS_LINK_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_LINK_REF),
                                new CSVAttributeMapper(VERSION_RIGHTS_LINK_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_LINK_VERSION),
                                new CSVAttributeMapper(ANNOTATION_RIGHTS_LINK_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_RIGHTS_LINK_ANNOTATION)),
                true);

        CSVElementMapper annotationElementMapper = new CSVElementMapper(ANNOTATION,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ANNOTATION,
                Arrays
                        .asList(new CSVAttributeMapper(ANNOTATION_TYPE_ANNOTATION_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ANNOTATION_ANNOTATION_TYPE),
                                new CSVAttributeMapper(SOURCE_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ANNOTATION_SOURCE),
                                new CSVAttributeMapper(REF_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ANNOTATION_REF),
                                new CSVAttributeMapper(VERSION_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ANNOTATION_VERSION),
                                new CSVAttributeMapper(ANNOTATION_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_ANNOTATION_ANNOTATION)));

        CSVElementMapper instantiationIdentifierElementMapper = new CSVElementMapper(INSTANTIATION_IDENTIFIER,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_IDENTIFIER,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATION_IDENTIFIER_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_IDENTIFIER_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_IDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_IDENTIFIER_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_IDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_IDENTIFIER_VERSION),
                                new CSVAttributeMapper(INSTANTIATION_IDENTIFIER_INSTANTIATION_IDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_IDENTIFIER_ANNOTATION)),
                true);

        CSVElementMapper instantiationDateElementMapper = new CSVElementMapper(INSTANTIATION_DATE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATE,
                Arrays
                        .asList(new CSVAttributeMapper(DATE_TYPE_INSTANTIATIONDATE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATE_DATE_TYPE),
                                new CSVAttributeMapper(SOURCE_INSTANTIATION_DATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATE_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_DATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATE_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_DATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_DATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATE_ANNOTATION)),
                true);

        CSVElementMapper instantiationDimensionsElementMapper = new CSVElementMapper(INSTANTIATION_DIMENSIONS,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIMENSIONS,
                Arrays
                        .asList(new CSVAttributeMapper(UNITSOF_MEASURE_INSTANTIATION_DIMENSIONS_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIMENSIONS_UNITSOFMEASURE),
                                new CSVAttributeMapper(SOURCE_INSTANTIATION_DIMENSIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIMENSIONS_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_DIMENSIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIMENSIONS_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_DIMENSIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIMENSIONS_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_DIMENSIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIMENSIONS_ANNOTATION)),
                true);

        CSVElementMapper instantiationPhysicalElementMapper = new CSVElementMapper(INSTANTIATION_PHYSICAL,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_PHYSICAL,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATIONPHYSICAL_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_PHYSICAL_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_PHYSICAL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_PHYSICAL_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_PHYSICAL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_PHYSICAL_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_PHYSICAL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_PHYSICAL_ANNOTATION)),
                true);

        CSVElementMapper instantiationDigitalElementMapper = new CSVElementMapper(INSTANTIATION_DIGITAL,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIGITAL,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATIONDIGITAL_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIGITAL_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_DIGITAL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIGITAL_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_DIGITAL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIGITAL_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_DIGITAL_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DIGITAL_ANNOTATION)),
                true);

        CSVElementMapper instantiationStandardElementMapper = new CSVElementMapper(INSTANTIATION_STANDARD,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_STANDARD,
                Arrays
                        .asList(new CSVAttributeMapper(PROFILE_STANDARD_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_STANDARD_PROFILE),
                                new CSVAttributeMapper(SOURCE_STANDARD_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_STANDARD_SOURCE),
                                new CSVAttributeMapper(REF_STANDARD_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_STANDARD_REF),
                                new CSVAttributeMapper(VERSION_STANDARD_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_STANDARD_VERSION),
                                new CSVAttributeMapper(ANNOTATION_STANDARD_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_STANDARD_ANNOTATION)),
                true);

        CSVElementMapper instantiationLocationElementMapper = new CSVElementMapper(INSTANTIATION_LOCATION,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LOCATION,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_LOCATION_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LOCATION_SOURCE),
                                new CSVAttributeMapper(REF_LOCATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LOCATION_REF),
                                new CSVAttributeMapper(VERSION_LOCATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LOCATION_VERSION),
                                new CSVAttributeMapper(ANNOTATION_LOCATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LOCATION_ANNOTATION)),
                true);

        CSVElementMapper instantiationMediaTypeElementMapper = new CSVElementMapper(INSTANTIATION_MEDIATYPE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_MEDIATYPE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_MEDIATYPE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_MEDIATYPE_SOURCE),
                                new CSVAttributeMapper(REF_MEDIATYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_MEDIATYPE_REF),
                                new CSVAttributeMapper(VERSION_MEDIATYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_MEDIATYPE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_MEDIATYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_MEDIATYPE_ANNOTATION)),
                true);

        CSVElementMapper instantiationGenerationsElementMapper = new CSVElementMapper(INSTANTIATION_GENERATIONS,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_GENERATIONS,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_GENERATIONS_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_GENERATIONS_SOURCE),
                                new CSVAttributeMapper(REF_GENERATIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_GENERATIONS_REF),
                                new CSVAttributeMapper(VERSION_GENERATIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_GENERATIONS_VERSION),
                                new CSVAttributeMapper(ANNOTATION_GENERATIONS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_GENERATIONS_ANNOTATION)),
                true);

        CSVElementMapper instantiationFileSizeElementMapper = new CSVElementMapper(INSTANTIATION_FILE_SIZE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_FILE_SIZE,
                Arrays
                        .asList(new CSVAttributeMapper(UNITS_OFMEASURE_FILESIZE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_FILE_SIZE_UNITSOFMEASURE),
                                new CSVAttributeMapper(SOURCE_FILESIZE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_FILE_SIZE_SOURCE),
                                new CSVAttributeMapper(REF_FILESIZE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_FILE_SIZE_REF),
                                new CSVAttributeMapper(VERSION_FILESIZE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_FILE_SIZE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_FILESIZE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_FILE_SIZE_ANNOTATION)),
                true);

        CSVElementMapper instantiationTimeStartElementMapper = new CSVElementMapper(INSTANTIATION_TIMESTART,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TIMESTART,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_TIMESTART_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TIMESTART_SOURCE),
                                new CSVAttributeMapper(REF_TIMESTART_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TIMESTART_REF),
                                new CSVAttributeMapper(VERSION_TIMESTART_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TIMESTART_VERSION),
                                new CSVAttributeMapper(ANNOTATION_TIMESTART_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TIMESTART_ANNOTATION)),
                true);

        CSVElementMapper instantiationDurationElementMapper = new CSVElementMapper(INSTANTIATION_DURATION,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DURATION,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_DURATION_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DURATION_SOURCE),
                                new CSVAttributeMapper(REF_DURATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DURATION_REF),
                                new CSVAttributeMapper(VERSION_DURATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DURATION_VERSION),
                                new CSVAttributeMapper(ANNOTATION_DURATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DURATION_ANNOTATION)),
                true);

        CSVElementMapper instantiationDataRateElementMapper = new CSVElementMapper(INSTANTIATION_DATARATE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATARATE,
                Arrays
                        .asList(new CSVAttributeMapper(UNITS_OFMEASURE_DATARATE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATARATE_UNITSOFMEASURE),
                                new CSVAttributeMapper(SOURCE_DATARATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATARATE_SOURCE),
                                new CSVAttributeMapper(REF_DATARATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATARATE_REF),
                                new CSVAttributeMapper(VERSION_DATARATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATARATE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_DATARATE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_DATARATE_ANNOTATION)),
                true);

        CSVElementMapper instantiationColorsElementMapper = new CSVElementMapper(INSTANTIATION_COLORS,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_COLORS,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_COLORS_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_COLORS_SOURCE),
                                new CSVAttributeMapper(REF_COLORS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_COLORS_REF),
                                new CSVAttributeMapper(VERSIONS_COLORS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_COLORS_VERSIONS),
                                new CSVAttributeMapper(ANNOTATION_COLORS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_COLORS_ANNOTATION)),
                true);

        CSVElementMapper instantiationTracksElementMapper = new CSVElementMapper(INSTANTIATION_TRACKS,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TRACKS,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_TRACKS_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TRACKS_SOURCE),
                                new CSVAttributeMapper(REF_TRACKS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TRACKS_REF),
                                new CSVAttributeMapper(VERSION_TRACKS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TRACKS_VERSION),
                                new CSVAttributeMapper(ANNOTATION_TRACKS_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_TRACKS_ANNOTATION)),
                true);

        CSVElementMapper instantiationChannelConfigurationElementMapper = new CSVElementMapper(
                INSTANTIATION_CHANNELCONFIGURATION,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_CHANNELCONFIGURATION,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_CHANNELCONFIGURATION_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_CHANNELCONFIGURATION_SOURCE),
                                new CSVAttributeMapper(REF_CHANNELCONFIGURATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_CHANNELCONFIGURATION_REF),
                                new CSVAttributeMapper(VERSION_CHANNELCONFIGURATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_CHANNELCONFIGURATION_VERSION),
                                new CSVAttributeMapper(ANNOTATION_CHANNELCONFIGURATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_CHANNELCONFIGURATION_ANNOTATION)),
                true);

        CSVElementMapper instantiationLanguageElementMapper = new CSVElementMapper(INSTANTIATION_LANGUAGE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LANGUAGE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_LANGUAGE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LANGUAGE_SOURCE),
                                new CSVAttributeMapper(REF_LANGUAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LANGUAGE_REF),
                                new CSVAttributeMapper(VERSION_LANGUAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LANGUAGE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_LANGUAGE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_LANGUAGE_ANNOTATION)),
                true);

        CSVElementMapper instantiationAlternativeModesElementMapper = new CSVElementMapper(
                INSTANTIATION_ALTERNATIVEMODES, PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ALTERNATIVEMODES,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_ALTERNATIVEMODES_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ALTERNATIVEMODES_SOURCE),
                                new CSVAttributeMapper(REF_ALTERNATIVEMODES_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ALTERNATIVEMODES_REF),
                                new CSVAttributeMapper(VERSION_ALTERNATIVEMODES_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ALTERNATIVEMODES_VERSION),
                                new CSVAttributeMapper(ANNOTATION_ALTERNATIVEMODES_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ALTERNATIVEMODES_ANNOTATION)),
                true);

        CSVElementMapper instantiationRelationTypeElementMapper = new CSVElementMapper(INSTANTIATION_RELATION_TYPE,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATION_TYPE,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATION_RELATIONTYPE_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATION_TYPE_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_RELATIONTYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATION_TYPE_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_RELATIONTYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATION_TYPE_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_RELATIONTYPE_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATION_TYPE_ANNOTATION)),
                true);

        CSVElementMapper instantiationRelationIdentifierElementMapper = new CSVElementMapper(
                INSTANTIATION_RELATIONIDENTIFIER, PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATIONIDENTIFIER,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATION_RELATIONIDENTIFIER_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATIONIDENTIFIER_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_RELATIONIDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATIONIDENTIFIER_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_RELATIONIDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATIONIDENTIFIER_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_RELATIONIDENTIFIER_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RELATIONIDENTIFIER_ANNOTATION)),
                true);

        CSVElementMapper instantiationRightsSummaryElementMapper = new CSVElementMapper(INSTANTIATION_RIGHTSSUMMARY,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSSUMMARY,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATION_RIGHTSSUMMARY_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSSUMMARY_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_RIGHTSSUMMARY_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSSUMMARY_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_RIGHTSSUMMARY_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSSUMMARY_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_RIGHTSSUMMARY_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSSUMMARY_ANNOTATION)),
                true);

        CSVElementMapper instantiationRightsLinkElementMapper = new CSVElementMapper(INSTANTIATION_RIGHTSLINK,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSLINK,
                Arrays
                        .asList(new CSVAttributeMapper(SOURCE_INSTANTIATION_RIGHTSLINK_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSLINK_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_RIGHTSLINK_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSLINK_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_RIGHTSLINK_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSLINK_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_RIGHTSLINK_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_RIGHTSLINK_ANNOTATION)),
                true);

        CSVElementMapper instantiationAnnotationElementMapper = new CSVElementMapper(INSTANTIATION_ANNOTATION,
                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ANNOTATION,
                Arrays
                        .asList(new CSVAttributeMapper(ANNOTATION_TYPE_INSTANTIATION_ANNOTATION_ATTR,
                                PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ANNOTATIONTYPE),
                                new CSVAttributeMapper(SOURCE_INSTANTIATION_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ANNOTATION_SOURCE),
                                new CSVAttributeMapper(REF_INSTANTIATION_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ANNOTATION_REF),
                                new CSVAttributeMapper(VERSION_INSTANTIATION_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ANNOTATION_VERSION),
                                new CSVAttributeMapper(ANNOTATION_INSTANTIATION_ANNOTATION_ATTR,
                                        PBCORE_DESCRIPTION_DOCUMENT_PBCORE_INSTANTIATION_ANNOTATION_ANNOTATION)),
                true);

        String file = File.separator + "v01" + File.separator + "mappers.json";
        ObjectMapper mapper = new ObjectMapper();
        List<CSVElementMapper> csvElementMappers = Arrays
                .asList(assetTypeElementMapper, assetDateElementMapper, identifierElementMapper, titleElementMapper,
                        subjectElementMapper, descriptionElementMapper, genreElementMapper, relationTypeElementMapper,
                        relationIdentifierElementMapper, coverageElementMapper, coverageTypeElementMapper,
                        audienceLevelElementMapper, audienceRatingElementMapper, creatorElementMapper,
                        creatorRoleElementMapper, contributorElementMapper, contributorRoleElementMapper,
                        publisherElementMapper, publisherRoleElementMapper, rightsSummaryElementMapper,
                        rightsLinkElementMapper, annotationElementMapper, instantiationIdentifierElementMapper,
                        instantiationDateElementMapper, instantiationDimensionsElementMapper,
                        instantiationPhysicalElementMapper, instantiationDigitalElementMapper,
                        instantiationStandardElementMapper, instantiationLocationElementMapper,
                        instantiationMediaTypeElementMapper, instantiationGenerationsElementMapper,
                        instantiationFileSizeElementMapper, instantiationTimeStartElementMapper,
                        instantiationDurationElementMapper, instantiationDataRateElementMapper,
                        instantiationColorsElementMapper, instantiationTracksElementMapper,
                        instantiationChannelConfigurationElementMapper, instantiationLanguageElementMapper,
                        instantiationAlternativeModesElementMapper, instantiationRelationTypeElementMapper,
                        instantiationRelationIdentifierElementMapper, instantiationRightsSummaryElementMapper,
                        instantiationRightsLinkElementMapper, instantiationAnnotationElementMapper);
        try {
            mapper.writeValue(new File(file), csvElementMappers);
        }
        catch (IOException e) {
            LOGGER.log(Level.WARNING, "error generating element mappers", e);
        }
    }
