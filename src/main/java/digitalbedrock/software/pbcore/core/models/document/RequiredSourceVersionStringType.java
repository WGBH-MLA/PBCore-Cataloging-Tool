...
/**
 * Definition: The requiredSourceVersionStringType schema type type is the same as sourceVersionStringType with the
 * addition that the source attribute is required instead of optional.
 *
 * <p>
